 ...
 */
case class TaskSpec(
    pluginSpec: Option[TaskSpecPluginSpec] = None,
    containerSpec: Option[TaskSpecContainerSpec] = None,
    networkAttachmentSpec: Option[TaskSpecNetworkAttachmentSpec] = None,
    resources: Option[TaskSpecResources] = None,
    restartPolicy: Option[TaskSpecRestartPolicy] = None,
    placement: Option[TaskSpecPlacement] = None,
    /* A counter that triggers an update even if no relevant parameters have been changed.  */
    forceUpdate: Option[Int] = None,
    /* Runtime is the type of runtime specified for the task executor.  */
    runtime: Option[String] = None,
    /* Specifies which networks the service should attach to. */
    networks: Option[Seq[NetworkAttachmentConfig]] = None,
    logDriver: Option[TaskSpecLogDriver] = None)
