...
case class GenericResourcesInner(
    namedResourceSpec: Option[GenericResourcesInnerNamedResourceSpec] = None,
    discreteResourceSpec: Option[GenericResourcesInnerDiscreteResourceSpec] = None)
