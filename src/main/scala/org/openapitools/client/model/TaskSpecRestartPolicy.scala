 ...
 */
case class TaskSpecRestartPolicy(
    /* Condition for restart. */
    condition: Option[TaskSpecRestartPolicyEnums.Condition] = None,
...
object TaskSpecRestartPolicyEnums:
...
end TaskSpecRestartPolicyEnums
