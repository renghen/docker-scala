...
import org.openapitools.client.model.Reachability.*

/**
 * ManagerStatus represents the status of a manager. It provides the current status of a node's
 * manager component, if the node is a manager.
 */
case class ManagerStatus(
    leader: Option[Boolean] = None,
    reachability: Option[Reachability] = None,
    /* The IP address and port at which the manager is reachable.  */
    addr: Option[String] = None)

object ManagerStatusEnums {}
