 ...
 */
case class HostConfigAllOfLogConfig(
    `type`: Option[HostConfigAllOfLogConfigEnums.`Type`] = None,
    config: Option[Map[String, String]] = None)

object HostConfigAllOfLogConfigEnums:
  ...
  object `Type` extends Enumeration:
    ...
    val Gelf     = Value("gelf")
    val Fluentd  = Value("fluentd")
    val Awslogs  = Value("awslogs")
    val Splunk   = Value("splunk")
    val Etwlogs  = Value("etwlogs")
    val None     = Value("none")

  end `Type`

end HostConfigAllOfLogConfigEnums
