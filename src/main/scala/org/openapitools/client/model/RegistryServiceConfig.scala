 ...
 */
case class RegistryServiceConfig(
    ...
    allowNondistributableArtifactsCIDRs: Option[Seq[String]] = None,
    ...
    allowNondistributableArtifactsHostnames: Option[Seq[String]] = None,
    ...
    insecureRegistryCIDRs: Option[Seq[String]] = None,
    indexConfigs: Option[Map[String, IndexInfo]] = None,
    /* List of registry URLs that act as a mirror for the official (`docker.io`) registry.  */
    mirrors: Option[Seq[String]] = None)
