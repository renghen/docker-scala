...
case class Network(
    ...
    attachable: Option[Boolean] = None,
    /* Whether the network is providing the routing-mesh for the swarm cluster.  */
    ingress: Option[Boolean] = None,
    configFrom: Option[ConfigReference] = None,
    ...
    configOnly: Option[Boolean] = None,
    /* Contains endpoints attached to the network.  */
    containers: Option[Map[String, NetworkContainer]] = None,
    ...
    peers: Option[Seq[PeerInfo]] = None)
