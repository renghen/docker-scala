...
/**
 * Additional metadata of the image in the local cache. This information is local to the daemon, and
 * not part of the image itself.
 */
case class ImageInspectMetadata(
    ...
    lastTagTime: Option[String] = None)
