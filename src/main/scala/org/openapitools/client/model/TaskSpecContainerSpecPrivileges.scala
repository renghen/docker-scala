 ...
 */
case class TaskSpecContainerSpecPrivileges(
    credentialSpec: Option[TaskSpecContainerSpecPrivilegesCredentialSpec] = None,
    sELinuxContext: Option[TaskSpecContainerSpecPrivilegesSELinuxContext] = None)
