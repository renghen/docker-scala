...
case class Mount(
    ...
    `type`: Option[MountEnums.`Type`] = None,
    /* Whether the mount should be read-only. */
    readOnly: Option[Boolean] = None,
    /* The consistency requirement for the mount: `default`, `consistent`, `cached`, or `delegated`. */
    consistency: Option[String] = None,
    bindOptions: Option[MountBindOptions] = None,
    volumeOptions: Option[MountVolumeOptions] = None,
    tmpfsOptions: Option[MountTmpfsOptions] = None)
...
object MountEnums:
  ...
  object `Type` extends Enumeration:
    ...
    val Tmpfs   = Value("tmpfs")
    val Npipe   = Value("npipe")
