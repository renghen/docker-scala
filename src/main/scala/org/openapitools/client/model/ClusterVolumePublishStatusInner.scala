...
case class ClusterVolumePublishStatusInner(
    ...
    state: Option[ClusterVolumePublishStatusInnerEnums.State] = None,
    /* A map of strings to strings returned by the CSI controller plugin when a volume is published.  */
    publishContext: Option[Map[String, String]] = None)

object ClusterVolumePublishStatusInnerEnums:

  type State = State.Value

  object State extends Enumeration:
    val PendingPublish             = Value("pending-publish")
    val Published                  = Value("published")
    val PendingNodeUnpublish       = Value("pending-node-unpublish")
    val PendingControllerUnpublish = Value("pending-controller-unpublish")

  end State

end ClusterVolumePublishStatusInnerEnums
