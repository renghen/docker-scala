...
case class ContainerInspectResponse(
    ...
    resolvConfPath: Option[String] = None,
    ...
    graphDriver: Option[GraphDriverData] = None,
    /* The size of files that have been created or changed by this container.  */
    sizeRw: Option[Long] = None,
    /* The total size of all the files in this container. */
    sizeRootFs: Option[Long] = None,
    mounts: Option[Seq[MountPoint]] = None,
    config: Option[ContainerConfig] = None,
    networkSettings: Option[NetworkSettings] = None)
