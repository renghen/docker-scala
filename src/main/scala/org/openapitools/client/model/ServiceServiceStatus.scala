...
/**
 * The status of the service's tasks. Provided only when requested as part of a ServiceList
 * operation.
 */
case class ServiceServiceStatus(
    /* The number of tasks for the service currently in the Running state.  */
    runningTasks: Option[Int] = None,
