 ...
 */
case class PluginConfigInterface(
    types: Seq[PluginInterfaceType],
    socket: String,
    /* Protocol to use for clients connecting to the plugin. */
    protocolScheme: Option[PluginConfigInterfaceEnums.ProtocolScheme] = None)

object PluginConfigInterfaceEnums:

  type ProtocolScheme = ProtocolScheme.Value

  object ProtocolScheme extends Enumeration:
    val Empty             = Value("")
    val MobyPluginsHttpV1 = Value("moby.plugins.http/v1")

  end ProtocolScheme

end PluginConfigInterfaceEnums
