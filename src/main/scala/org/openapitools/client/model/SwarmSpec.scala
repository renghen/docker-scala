 ...
 */
case class SwarmSpec(
    /* Name of the swarm. */
    name: Option[String] = None,
    /* User-defined key/value metadata. */
    labels: Option[Map[String, String]] = None,
    orchestration: Option[SwarmSpecOrchestration] = None,
    raft: Option[SwarmSpecRaft] = None,
    dispatcher: Option[SwarmSpecDispatcher] = None,
    cAConfig: Option[SwarmSpecCAConfig] = None,
    encryptionConfig: Option[SwarmSpecEncryptionConfig] = None,
    taskDefaults: Option[SwarmSpecTaskDefaults] = None)
