 ...
 */
case class MountBindOptions(
    /* A propagation mode with the value `[r]private`, `[r]shared`, or `[r]slave`. */
    propagation: Option[MountBindOptionsEnums.Propagation] = None,
    /* Disable recursive bind mount. */
    nonRecursive: Option[Boolean] = None,
    /* Create mount point on host if missing */
    createMountpoint: Option[Boolean] = None)

object MountBindOptionsEnums:

  type Propagation = Propagation.Value

  object Propagation extends Enumeration:
    val `Private` = Value("private")
    val Rprivate  = Value("rprivate")
    val Shared    = Value("shared")
    val Rshared   = Value("rshared")
    val Slave     = Value("slave")
    val Rslave    = Value("rslave")

  end Propagation

end MountBindOptionsEnums
