...
import org.openapitools.client.model.LocalNodeState.*

/**
 * Represents generic information about swarm.
 */
case class SwarmInfo(
    /* Unique identifier of for this node in the swarm. */
    nodeID: Option[String] = None,
    /* IP address at which this node can be reached by other nodes in the swarm.  */
    nodeAddr: Option[String] = None,
    localNodeState: Option[LocalNodeState] = None,
    controlAvailable: Option[Boolean] = None,
    error: Option[String] = None,
    /* List of ID's and addresses of other managers in the swarm.  */
    remoteManagers: Option[Seq[PeerNode]] = None,
    /* Total number of nodes in the swarm. */
    nodes: Option[Int] = None,
    /* Total number of managers in the swarm. */
    managers: Option[Int] = None,
    cluster: Option[ClusterInfo] = None)

object SwarmInfoEnums {}
