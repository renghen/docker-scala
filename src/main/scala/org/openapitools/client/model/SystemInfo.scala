...
case class SystemInfo(
    ...
    containersRunning: Option[Int] = None,
    /* Number of containers with status `\"paused\"`.  */
    containersPaused: Option[Int] = None,
    /* Number of containers with status `\"stopped\"`.  */
    containersStopped: Option[Int] = None,
    ...
    driverStatus: Option[Seq[Seq[String]]] = None,
    /* Root directory of persistent Docker state.  Defaults to `/var/lib/docker` on Linux, and `C:\\ProgramData\\docker` on Windows.  */
    dockerRootDir: Option[String] = None,
    plugins: Option[PluginsInfo] = None,
    /* Indicates if the host has memory limit support enabled. */
    memoryLimit: Option[Boolean] = None,
    /* Indicates if the host has memory swap limit support enabled. */
    swapLimit: Option[Boolean] = None,
    ...
    kernelMemoryTCP: Option[Boolean] = None,
    /* Indicates if CPU CFS(Completely Fair Scheduler) period is supported by the host.  */
    cpuCfsPeriod: Option[Boolean] = None,
    /* Indicates if CPU CFS(Completely Fair Scheduler) quota is supported by the host.  */
    cpuCfsQuota: Option[Boolean] = None,
    /* Indicates if CPU Shares limiting is supported by the host.  */
    cPUShares: Option[Boolean] = None,
    ...
    cPUSet: Option[Boolean] = None,
    /* Indicates if the host kernel has PID limit support enabled. */
    pidsLimit: Option[Boolean] = None,
    /* Indicates if OOM killer disable is supported on the host. */
    oomKillDisable: Option[Boolean] = None,
    /* Indicates IPv4 forwarding is enabled. */
    iPv4Forwarding: Option[Boolean] = None,
    /* Indicates if `bridge-nf-call-iptables` is available on the host. */
    bridgeNfIptables: Option[Boolean] = None,
    /* Indicates if `bridge-nf-call-ip6tables` is available on the host. */
    bridgeNfIp6tables: Option[Boolean] = None,
    ...
    nGoroutines: Option[Int] = None,
    /* Current system-time in [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) format with nano-seconds.  */
    systemTime: Option[String] = None,
    /* The logging driver to use as a default for new containers.  */
    loggingDriver: Option[String] = None,
    /* The driver to use for managing cgroups.  */
    cgroupDriver: Option[SystemInfoEnums.CgroupDriver] = None,
    /* The version of the cgroup.  */
    cgroupVersion: Option[SystemInfoEnums.CgroupVersion] = None,
    /* Number of event listeners subscribed. */
    nEventsListener: Option[Int] = None,
    ...
    NCPU: Option[Int] = None,
    /* Total amount of physical memory available on the host, in bytes.  */
    memTotal: Option[Long] = None,
    /* Address / URL of the index server that is used for image search, and as a default for user authentication for Docker Hub and Docker Cloud.  */
    indexServerAddress: Option[String] = None,
    registryConfig: Option[RegistryServiceConfig] = None,
    /* User-defined resources can be either Integer resources (e.g, `SSD=3`) or String resources (e.g, `GPU=UUID1`).  */
    genericResources: Option[Seq[GenericResourcesInner]] = None,
    ...
    experimentalBuild: Option[Boolean] = None,
    ...
    runtimes: Option[Map[String, Runtime]] = None,
    ...
    defaultRuntime: Option[String] = None,
    swarm: Option[SwarmInfo] = None,
    ...
    liveRestoreEnabled: Option[Boolean] = None,
    /* Represents the isolation technology to use as a default for containers. The supported values are platform-specific.  If no isolation value is specified on daemon start, on Windows client, the default is `hyperv`, and on Windows server, the default is `process`.  This option is currently not used on other platforms.  */
    isolation: Option[SystemInfoEnums.Isolation] = None,
    ...
    initBinary: Option[String] = None,
    containerdCommit: Option[Commit] = None,
    runcCommit: Option[Commit] = None,
    initCommit: Option[Commit] = None,
    ...
    securityOptions: Option[Seq[String]] = None,
    ...
    productLicense: Option[String] = None,
    ...
    defaultAddressPools: Option[Seq[SystemInfoDefaultAddressPoolsInner]] = None,
...
object SystemInfoEnums:

  type CgroupDriver  = CgroupDriver.Value
  type CgroupVersion = CgroupVersion.Value
  type Isolation     = Isolation.Value

  object CgroupDriver extends Enumeration:
    val Cgroupfs = Value("cgroupfs")
    val Systemd  = Value("systemd")
    val None     = Value("none")

  end CgroupDriver

  object CgroupVersion extends Enumeration:
    val `1` = Value("1")
    val `2` = Value("2")
