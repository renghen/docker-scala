...
case class SystemDataUsageResponse(
    layersSize: Option[Long] = None,
    images: Option[Seq[ImageSummary]] = None,
    containers: Option[Seq[ContainerSummary]] = None,
    volumes: Option[Seq[Volume]] = None,
    buildCache: Option[Seq[BuildCache]] = None)
