...
case class ServiceCreateRequest(
    /* Name of the service. */
    name: Option[String] = None,
    /* User-defined key/value metadata. */
    labels: Option[Map[String, String]] = None,
    taskTemplate: Option[TaskSpec] = None,
    mode: Option[ServiceSpecMode] = None,
    updateConfig: Option[ServiceSpecUpdateConfig] = None,
    rollbackConfig: Option[ServiceSpecRollbackConfig] = None,
    /* Specifies which networks the service should attach to. */
    networks: Option[Seq[NetworkAttachmentConfig]] = None,
    endpointSpec: Option[EndpointSpec] = None)
