...
/**
 * Describes the platform which the image in the manifest runs on, as defined in the [OCI Image
 * Index Specification](https://github.com/opencontainers/image-spec/blob/v1.0.1/image-index.md).
 */
case class OCIPlatform(
    ...
    osFeatures: Option[Seq[String]] = None,
