...
case class BuildCache(
    ...
    /* Cache record type.  */
    `type`: Option[BuildCacheEnums.`Type`] = None,
...
object BuildCacheEnums:
  ...
  object `Type` extends Enumeration:
    ...
    val SourceLocal       = Value("source.local")
    val SourceGitCheckout = Value("source.git.checkout")
    val ExecCachemount    = Value("exec.cachemount")
