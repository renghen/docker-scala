...
/**
 * Runtime describes an [OCI compliant](https://github.com/opencontainers/runtime-spec) runtime. The
 * runtime is invoked by the daemon via the `containerd` daemon. OCI runtimes act as an interface to
...
case class Runtime(
    ...
    runtimeArgs: Option[Seq[String]] = None)
