 ...
 */
case class ServiceSpecMode(
    replicated: Option[ServiceSpecModeReplicated] = None,
    global: Option[String] = None,
    replicatedJob: Option[ServiceSpecModeReplicatedJob] = None,
    /* The mode used for services which run a task to the completed state on each valid node.  */
    globalJob: Option[String] = None)
