...
case class SwarmSpecCAConfigExternalCAsInner(
    /* Protocol for communication with the external CA (currently only `cfssl` is supported).  */
    protocol: Option[SwarmSpecCAConfigExternalCAsInnerEnums.Protocol] = None,
...
object SwarmSpecCAConfigExternalCAsInnerEnums:

  type Protocol = Protocol.Value

  object Protocol extends Enumeration:
    val Cfssl = Value("cfssl")

  end Protocol

end SwarmSpecCAConfigExternalCAsInnerEnums
