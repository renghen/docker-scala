...
case class EndpointPortConfig(
    name: Option[String] = None,
    protocol: Option[EndpointPortConfigEnums.Protocol] = None,
    /* The port inside the container. */
    targetPort: Option[Int] = None,
    /* The port on the swarm hosts. */
    publishedPort: Option[Int] = None,
    ...
    publishMode: Option[EndpointPortConfigEnums.PublishMode] = None)

object EndpointPortConfigEnums:

  type Protocol    = Protocol.Value
  type PublishMode = PublishMode.Value
  ...
  object PublishMode extends Enumeration:
    val Ingress = Value("ingress")
    val Host    = Value("host")

  end PublishMode

end EndpointPortConfigEnums
