 ...
 */
case class ServiceSpecRollbackConfig(
    /* Maximum number of tasks to be rolled back in one iteration (0 means unlimited parallelism).  */
    parallelism: Option[Long] = None,
    /* Amount of time between rollback iterations, in nanoseconds.  */
    delay: Option[Long] = None,
    /* Action to take if an rolled back task fails to run, or stops running during the rollback.  */
    failureAction: Option[ServiceSpecRollbackConfigEnums.FailureAction] = None,
    ...
    order: Option[ServiceSpecRollbackConfigEnums.Order] = None)

object ServiceSpecRollbackConfigEnums:
...
end ServiceSpecRollbackConfigEnums
